...
This will install the dependency [s3fs](https://www.npmjs.com/package/s3fs) to our *upload-code* application.
...
Back to coding. In you *app.js* file, add the following script:
```js:app.js
...
This will fetch all the file paths of the files in the folder into an array *files*. 
