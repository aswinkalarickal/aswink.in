...
What it did was, iterate through every line of the file *contacts.vcf* and print the lines having the word *EMAIL* in it. 
Then all the new lines are cut using delimiter *colon(:)* and the strings obtained are saved to file *email.txt*.
